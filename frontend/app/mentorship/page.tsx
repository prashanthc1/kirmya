...
const MENTOR_TOPICS = [
  {
    ...
    desc: "Make your actual experience pop.",
  },
  {
    icon: TargetIcon,
    title: "Interview Practice",
    desc: "Interactive mock rounds & feedback.",
  },
  {
    icon: MoveIcon,
    title: "Career Path Pivots",
    desc: "Translate skills into a new niche.",
  },
  {
    icon: HandshakeIcon,
    title: "Offer Negotiation",
    desc: "Know your market worth & request it.",
  },
];
...
function MoveIcon() {
  return <HeartHandshake className="h-5 w-5 text-primary" />;
}
...
export default function MentorshipPage() {
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col relative overflow-hidden">
      ...
      <SiteNav
        breadcrumb={[{ label: "Home", href: "/" }, { label: "Mentorship" }]}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-xl leading-relaxed">
              Get matched with an experienced industry professional who has
              navigated a career layoff and come out stronger — or pay it
              forward by guiding someone through theirs.
            </p>
          ...
          <div className="lg:col-span-5 bg-card border border-border/80 p-6 rounded-3xl shadow-lg relative overflow-hidden">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  Sr. Logistics Manager &bull; 17 years exp
                </p>
              </div>
            ...
            <p className="text-base font-semibold leading-relaxed text-foreground italic mb-4">
              &ldquo;I had three mentors when I was laid off in 2009. This is
              how I pass that forward.&rdquo;
            </p>

            <div className="flex flex-wrap gap-1.5">
              {["Career pivots", "Interview prep", "Offer negotiation"].map(
                (tag) => (
                  <span
                    key={tag}
                    className="text-[10px] px-2.5 py-0.5 bg-secondary text-muted-foreground rounded-full border border-border/40 font-semibold"
                  >
                    {tag}
                  </span>
                ),
        ...
        <div className="bg-card border border-border/60 p-8 rounded-3xl grid grid-cols-2 md:grid-cols-4 gap-6 text-center shadow-sm">
          {STATS.map((stat, idx) => (
            <div key={idx} className="space-y-1">
              <span className="text-3xl font-black tracking-tight text-primary block">
                {stat.metric}
              </span>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-2">
            ...
            <h2 className="text-3xl font-extrabold tracking-tight">
              Structured coaching in three steps
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {STEPS.map((step) => (
              <div
                key={step.step}
                className="bg-card border border-border/50 p-8 rounded-3xl space-y-4 shadow-sm hover:border-border transition-all"
              >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Our mentors are not career coaches — they are active industry
              professionals who have stood in your shoes. Their advice is
              tactical, transparent, and built on real experience.
            </p>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {MENTOR_TOPICS.map((topic, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-card border border-border/60 p-6 rounded-2xl space-y-2 hover:border-border transition-all shadow-sm"
                >
                  <Icon />
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-20">
        <div className="bg-gradient-to-br from-emerald-500 to-teal-600 dark:from-emerald-600 dark:to-teal-700 p-8 md:p-12 rounded-3xl text-center space-y-6 text-white shadow-xl shadow-emerald-500/5">
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">
            Find an internal advisor today
          </h2>
          <p className="text-sm md:text-base text-emerald-100 max-w-md mx-auto leading-relaxed">
            Browse our database of 2,100+ mentors who have walked this road.
            Your initial alignment session is completely free.
          </p>
          <Link
            href="/mentors"
